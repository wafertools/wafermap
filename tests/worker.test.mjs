...
test('createWafermapWorker handles out-of-order responses', async () => {
  ...
  const input1 = { results: [{ x: 0, y: 0, values: [1], bins: [1] }], waferConfig: { diameter: 40 }, dieConfig: { width: 10, height: 10 } };
  const input2 = { results: [{ x: 1, y: 1, values: [2], bins: [2] }], waferConfig: { diameter: 40 }, dieConfig: { width: 10, height: 10 } };
