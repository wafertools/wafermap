...
const SNAPSHOTS = {
  '.' : [
    ...
    'pearsonFromSums', 'pearsonOfPairs',
    'dieHasTestData',
  ...
  './stats': [
    ...
    'pearsonFromSums', 'pearsonOfPairs',
    'filterFindings', 'visibleFindings', 'openHtmlReport', 'parseRegionKey', 'resolveMetadataColumns', 'discoverDieMetadataKeys', 'sectorCompassNames', 'setReportOpener',
    'renderFindingsReportHtml', 'renderLotSummaryReportHtml', 'renderSummaryReportHtml',
  ],
  './render': [
